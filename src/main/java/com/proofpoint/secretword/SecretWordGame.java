...
public final class SecretWordGame {
  /**
  ...
  /**
   * The word that needs to be guessed (e.g. 'APPLE')
   */
  ...
  /**
   * The letters guessed so far (unknown letters will be marked by the MYSTERY_LETTER constant). For example, '-PP--'
   */
  private final char[] guessedSoFar;

  /**
   * Set of all correct letter guesses so far (e.g. 'A', 'E', 'L')
   */
  ...
  /**
   * Set of all incorrect word guesses so far (e.g. 'ACORN')
   */
   ...
   */
  public SecretWordGame(String secretWord, int maxWrongGuesses) {
